...
public class TareasBo {
    ...
    Logger LOGGER = LoggerFactory.getLogger(TareasBo.class);

    @Bean("calculoDeTareasPorDia")
    public List<TareasModels> calculoDeTareasPorDia() {
        ...
        List<TareasModels> listaFinal = Arrays.asList(tareasModelss);
